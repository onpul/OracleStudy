...
( HAKBUN    NUMBER          -- CHECK~!!! (학번은 NUMBER로 만들면 안 된다...)
, NAME      VARCHAR2(40)
, KOR       NUMBER(3)
, ENG       NUMBER(3)
, MAT       NUMBER(3) -- 실수 ㅠㅠ 원래 3으로 입력해야 함 --> 드롭하고 다시 만들어서 수정함
, CONSTRAINT SUNGJUK_HAKBUN_PK PRIMARY KEY(HAKBUN)
);

DROP TABLE TBL_SUNGJUK; -- 데이터 크기 잘못입력해서 드롭하고 다시 만듦
...
-- 컬럼으로 넣어야 하는지, 기존의 컬럼으로 얻어낼 수 있는지 명확하게 판단 후 테이블 설계.
